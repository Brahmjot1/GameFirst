...
import static com.player.cricketfirst.MyApplication.getContext;
...
import com.player.cricketfirst.adapter.ApplistAdapter;
import com.player.cricketfirst.adapter.CricketHomeListAdapter;
import com.player.cricketfirst.adapter.HomeStoryAdapter;
import com.player.cricketfirst.adapter.MenulistAdapter;
import com.player.cricketfirst.async.DownloadImageShareAsync;
import com.player.cricketfirst.model.CategoryModel;
import com.player.cricketfirst.model.ResponseModel;
import com.player.cricketfirst.util.AdEventListener;
import com.player.cricketfirst.util.Global_App;
import com.player.cricketfirst.util.Utility;
import com.player.cricketfirst.util.font.BoldTextView;
import com.player.cricketfirst.util.font.RegularTextView;
import com.player.cricketfirst.util.recyclerviewpager.PagerAdapter;
import com.player.cricketfirst.util.recyclerviewpager.PagerModel;
import com.player.cricketfirst.util.recyclerviewpager.RecyclerViewPager;
import com.player.cricketfirst.util.storyview.StoryView;
import com.player.cricketfirst.util.storyview.callback.OnStoryChangedCallback;
import com.player.cricketfirst.util.storyview.callback.StoryClickListeners;
