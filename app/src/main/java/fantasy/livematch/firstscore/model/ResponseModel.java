package fantasy.livematch.firstscore.model;


import fantasy.livematch.firstscore.util.storyview.model.MyStory;

import java.util.ArrayList;

public class ResponseModel {
    private String message,topImage,deplinkdata,topUrl,homeSiteUrl,buttomeNote,country,homeNote,teamName1,ipaddress,teamNote,checkSpinNum,lastDate,todayDate,daily_spinner_limit,remain_spin,earningPoint,teamName2, status,isCricket,isFootbal,isKabaddi,isBasketbollList,shareMessage,shareUrl,appVersion,appUrl,isForupdate,updateMessage,totalPage,totalIteam,currentPage;
    private ArrayList<CategoryModel> homeSlider,offerList,contestList,appList,adAppList,manuList,basketbollList,notificationList,data,withdrawList,walletList,teamList,cricketList,footballList,kabaddiList,Spindata,iconList;
    private CategoryModel matchDetails,homeDiloage,BottemBanner,MenuBanner;
    ArrayList<MyStory> storyView;
    private CategoryModel scratchCard;
    private CategoryModel exitDialoge;
    String googole_bannerID,isGoogleAdshow,isApplovinAdshow,googole_reawardID,adGBanner,adGInd,adGReward,mailId,privacyPolicy,isShowMoreApps,primeSiteUrl,googole_appOpenID,googole_indstrialID,googole_nativeID;
    String lovin_appOpenID,lovin_bannerID,lovin_indstrialID,lovin_reawardID,lovin_nativeID;
    ...
    private CategoryModel teampreview,fullDetails;
    private String isShowIndstrial,adFailUrl,nativeAdType,appOpenAdType,homeDilogeNote,homeDilogeTitle,newsUrl,offerListMain;

    public ArrayList<CategoryModel> getOfferList() {
        return offerList;
    }

    public void setOfferList(ArrayList<CategoryModel> offerList) {
        this.offerList = offerList;
    }

    public String getOfferListMain() {
        return offerListMain;
    }

    public void setOfferListMain(String offerListMain) {
        this.offerListMain = offerListMain;
    }

    public String getHomeDilogeNote() {
        return homeDilogeNote;
    }
    ...
    public void setHomeDilogeNote(String homeDilogeNote) {
        this.homeDilogeNote = homeDilogeNote;
    }

    public String getHomeDilogeTitle() {
        return homeDilogeTitle;
    }

    public void setHomeDilogeTitle(String homeDilogeTitle) {
        this.homeDilogeTitle = homeDilogeTitle;
    }
    ...
    public void setButtomeNote(String buttomeNote) {
        this.buttomeNote = buttomeNote;
    }
    ...
    public void setManuList(ArrayList<CategoryModel> manuList) {
    ...
    public void setSpinData(CategoryModel spinData) {
        this.spinData = spinData;
    }

    public String getLovin_appOpenID() {
        return lovin_appOpenID;
    }

    public void setLovin_appOpenID(String lovin_appOpenID) {
        this.lovin_appOpenID = lovin_appOpenID;
    }
    ...
    public void setLovin_bannerID(String lovin_bannerID) {
    ...
    public void setLovin_indstrialID(String lovin_indstrialID) {
    ...
    public void setLovin_reawardID(String lovin_reawardID) {
        this.lovin_reawardID = lovin_reawardID;
    }

    public String getLovin_nativeID() {
        return lovin_nativeID;
    }

    public void setLovin_nativeID(String lovin_nativeID) {
        this.lovin_nativeID = lovin_nativeID;
    }
    ...
    public void setScratchCard(CategoryModel scratchCard) {
        this.scratchCard = scratchCard;
    }

    public CategoryModel getLiveMatchBanner() {
        return liveMatchBanner;
    }
    ...
    public void setTeampreview(CategoryModel teampreview) {
    ...
    public void setFullDetails(CategoryModel fullDetails) {
        this.fullDetails = fullDetails;
    }

    public void setLiveMatchBanner(CategoryModel liveMatchBanner) {
        this.liveMatchBanner = liveMatchBanner;
    }
    ...
    public void setAppOpenAdType(String appOpenAdType) {
        this.appOpenAdType = appOpenAdType;
    }
    ...
    public void setPrimeSiteUrl(String primeSiteUrl) {
        this.primeSiteUrl = primeSiteUrl;
    }
    ...
    public void setAppList(ArrayList<CategoryModel> appList) {
    ...
    public void setIsShowMoreApps(String isShowMoreApps) {
        this.isShowMoreApps = isShowMoreApps;
    }
    ...
    public void setIconList(ArrayList<CategoryModel> iconList) {
    ...
    public void setIsGoogleAdshow(String isGoogleAdshow) {
        this.isGoogleAdshow = isGoogleAdshow;
    }
    ...
    public void setAdGBanner(String adGBanner) {
        this.adGBanner = adGBanner;
    }
    ...
    public void setAdGInd(String adGInd) {
        this.adGInd = adGInd;
    }
    ...
    public void setAdGReward(String adGReward) {
        this.adGReward = adGReward;
    }
    ...
    public void setDeplinkdata(String deplinkdata) {
        this.deplinkdata = deplinkdata;
    }
    ...
    public void setStoryView(ArrayList<MyStory> storyView) {
    ...
    public void setMenuBanner(CategoryModel menuBanner) {
    ...
    public void setContestList(ArrayList<CategoryModel> contestList) {
    ...
    public String getIsBasketbollList() {
        return isBasketbollList;
    }

    public void setIsBasketbollList(String isBasketbollList) {
        this.isBasketbollList = isBasketbollList;
    }

    public ArrayList<CategoryModel> getBasketbollList() {
        return basketbollList;
    }

    public void setBasketbollList(ArrayList<CategoryModel> basketbollList) {
        this.basketbollList = basketbollList;
    }
    ...
    public void setSpindata(ArrayList<CategoryModel> spindata) {
        Spindata = spindata;
    }
    ...
    public void setIsCricket(String isCricket) {
    ...
    public void setIsFootbal(String isFootbal) {
        this.isFootbal = isFootbal;
    }
    ...
    public void setIsKabaddi(String isKabaddi) {
        this.isKabaddi = isKabaddi;
    }
    ...
    public void setCricketList(ArrayList<CategoryModel> cricketList) {
    ...
    public void setFootballList(ArrayList<CategoryModel> footballList) {
    ...
    public void setKabaddiList(ArrayList<CategoryModel> kabaddiList) {
        this.kabaddiList = kabaddiList;
    }
    ...
    public void setTeamList(ArrayList<CategoryModel> teamList) {
    ...
    public void setMatchDetails(CategoryModel matchDetails) {
    ...
    public void setGoogole_appOpenID(String googole_appOpenID) {
    ...
    public void setGoogole_indstrialID(String googole_indstrialID) {
    ...
    public void setGoogole_nativeID(String googole_nativeID) {
    ...
    public void setGoogole_reawardID(String googole_reawardID) {
    ...
    public void setGoogole_bannerID(String googole_bannerID) {
    ...
    public void setAdAppList(ArrayList<CategoryModel> adAppList) {
